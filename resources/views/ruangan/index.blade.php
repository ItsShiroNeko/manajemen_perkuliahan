<x-layouts.dashboard title="Data Ruangan">
    <div class="bg-white p-4 rounded shadow w-full">
        <h1 class="text-2x1 font-bold mb-4">Data Ruangan</h1>

        {{-- Search & Tambah Data --}}
        <div class="flex justify-between mb-4">
            <input type="text" id="search" placeholder="Cari ID atau Nama Ruangan..." class="border p-2 rounded w-64"
            ...
            <table class="w-full border">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="p-2 border">Kode Ruangan</th>
                        <th class="p-2 border">Nama Ruangan</th>
                        <th class="p-2 border">Gedung</th>
                        <th class="p-2 border">Lantai</th>
                        <th class="p-2 border">Kapasitas</th>
                        <th class="p-2 border">Jenis Ruangan</th>
        ...
        {{-- Script --}}
        <script src="{{ asset('js/ruangan/ruangan.js') }}"></script>
        <script src="{{ asset('js/ruangan/ruangan-create.js') }}"></script>
        <script src="{{ asset('js/ruangan/ruangan-edit.js') }}"></script>
