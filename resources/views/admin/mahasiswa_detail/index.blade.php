<x-layouts.dashboard title="Detail Mahasiswa">
    <div class="bg-white p-6 rounded shadow w-full">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.mahasiswa') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600">
                Kembali
            </a>
        </div>
    ...
    {{-- Script --}}
    <script src="{{ asset('js/admin/mahasiswa/mahasiswa-detail.js') }}"></script>
