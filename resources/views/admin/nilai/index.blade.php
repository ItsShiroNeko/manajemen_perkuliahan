<x-layouts.dashboard title="Data Nilai">
    <div class="bg-white p-4 rounded shadow w-full">
        <h1 class="text-2x1 font-bold mb-4">Data Nilai</h1>

        {{-- Search & Tambah Data --}}
        <div class="flex justify-between mb-4">
            <input type="text" id="search" placeholder="Cari ID atau Nama Nilai..." class="border p-2 rounded w-64"
                oninput="searchNilai()">
            ...
            <table class="w-full border">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="p-2 border">Nilai Mutu</th>
                        <th class="p-2 border">Status</th>
                        <th class="p-2 border">Aksi</th>
                    </tr>
                </thead>
                <tbody id="dataNilai"></tbody>
            </table>
