<x-layouts.dashboard title="Data Jurusan">
    <div class="bg-white p-4 rounded shadow w-full">
        <h1 class="text-2x1 font-bold mb-4">Data Jurusan</h1>

        {{-- Search & Tambah Data --}}
        <div class="flex justify-between mb-4">
            <input type="text" id="search" placeholder="Cari ID atau Nama Jurusan..." class="border p-2 rounded w-64"
            ...
            <table class="w-full border">
                <thead class="bg-gray-200">
                    <tr>
                        ...
                        <th class="p-2 border">Kode Jurusan</th>
                        <th class="p-2 border">Nama Jurusan</th>
                        <th class="p-2 border">Fakultas</th>
                        <th class="p-2 border">Jenjang</th>
                        <th class="p-2 border">Akreditasi</th>
                        <th class="p-2 border">Kaprodi</th>
                        <th class="p-2 border">Aksi</th>
                    </tr>
                </thead>
                <tbody id="dataJurusan"></tbody>
            </table>
        ...
        <div id="tableArsip" class="hidden">
            <table class="w-full border">
                ...
                <tbody id="dataJurusanArsip"></tbody>
            </table>
        ...
        {{-- Script --}}
        <script src="{{ asset('js/jurusan/jurusan.js') }}"></script>
        <script src="{{ asset('js/jurusan/jurusan-create.js') }}"></script>
        <script src="{{ asset('js/jurusan/jurusan-edit.js') }}"></script>
