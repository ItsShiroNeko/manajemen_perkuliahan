<x-layouts.dashboard title="Data Fakultas">
    <div class="bg-white p-4 rounded shadow w-full">
        ...
        {{-- Script --}}
        <script src="{{ asset('js/fakultas/fakultas.js') }}"></script>
        <script src="{{ asset('js/fakultas/fakultas-create.js') }}"></script>
        <script src="{{ asset('js/fakultas/fakultas-edit.js') }}"></script>
