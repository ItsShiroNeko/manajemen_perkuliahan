<x-layouts.dashboard title="Data Dosen">
    <div class="bg-white p-4 rounded shadow w-full">
        ...
        <div class="flex justify-between mb-4">
            <input type="text" id="search" placeholder="Cari NIDN, Nama, atau Jurusan..." class="border p-2 rounded w-64"
                oninput="searchDosen()">
                ...
                <table class="w-full border">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="p-2 border">Gelar</th>
                            <th class="p-2 border">Jurusan</th>
                            <th class="p-2 border">Jenis Kelamin</th>
                            <th class="p-2 border">Status Kepegawaian</th>
        ...
        {{-- Script --}}
        <script src="{{ asset('js/dosen/dosen-edit.js') }}"></script>
        <script src="{{ asset('js/dosen/dosen-create.js') }}"></script>
